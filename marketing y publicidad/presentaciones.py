...
— Índice jerárquico con enlaces a todas las presentaciones
...
<body>
  <div class="wrap">
    <h1>Índice de presentaciones</h1>
...
def main():
    ...
    for md_path in md_files:
        ...
        # Entrada de índice para este documento
    ...
    # Escribe índice global
    write_index(outdir, index_data)
    print(f"[OK] Índice generado en: {outdir / 'index.html'}")
